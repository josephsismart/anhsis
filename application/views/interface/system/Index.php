...
<head>
    ...
    <title>Agusan National High School</title>
                        ...
                        <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img class="d-block w-100" src="<?= base_url() ?>dist/img/banners/b1_1.jpg" alt="First slide">
                                ...
                                <div class="carousel-item">
                                    <img class="d-block w-100" src="<?= base_url() ?>dist/img/banners/b2_1.jpg" alt="Second slide">
                                    <!-- <div class="carousel-caption d-none d-md-block">
                                ...
                                <div class="carousel-item">
                                    <img class="d-block w-100" src="<?= base_url() ?>dist/img/banners/b3_1.jpg" alt="Third slide">
                                </div>
                                <div class="carousel-item">
                                    <img class="d-block w-100" src="<?= base_url() ?>dist/img/banners/b4.jpg" alt="Third slide">
                                </div>
                            </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 text-center">
                                            <a href="http://ebeis.deped.gov.ph" target="_blank">
                                                <img class="img-fluid pad mb-3 img-circle" width="200" src="<?= base_url() ?>/dist/img/media/personnel/2023/5/4_4.jpg" alt="Photo">
                                            </a>
                                        </div>
                                        <div class="col-12 text-center">
