...
<head>
    <?php $this->load->view('interface/' . $uri2 . '/layout/Css'); ?>
...
<body class="hold-transition layout-fixed layout-navbar-fixed sidebar-collapse layout-top-nav text-sm">
    <div class="wrapper">
        ...
        <!-- /.control-sidebar -->
        <?php $this->load->view('interface/' . $uri2 . '/layout/Modal') ?>
        <?php $this->load->view('interface/' . $uri2 . '/layout/ModalReport') ?>
    </div>
    
    <?php $this->load->view('interface/' . $uri2 . '/layout/Js'); ?>
